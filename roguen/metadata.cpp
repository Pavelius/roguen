...
BSDATA(varianti) = {
	...
	{"Quest", VAR(quest), 0},
	{"Race", VAR(racei), 1, 0, fiscript<racei>, 0, 0, 0, fiallow<racei>},
	...
	{"Site", VAR(sitei), 1, 0, fiscript<sitei>, 0, 0, 0, fiallow<sitei>},
	{"SiteSkill", VAR(siteskilli), 1, 0, 0, 0, 0, check_site_skills},
	{"Spell", VAR(spelli), 1, 0, fiscript<spelli>, 0, 0, 0, fiallow<spelli>},
