...
BSDATA(varianti) = {
	{"NoVariant"},
	{"Ability", VAR(abilityi), 1, 0, fnscript<abilityi>, fntest<abilityi>},
	{"Advancement", VAR(advancement), 2},
	{"AreaFlag", VAR(areafi), 1, 0, fnscript<areafi>},
	{"Craft", VAR(crafti), 1, 0, fnscript<crafti>},
	{"Creature", VAR(creature), 0},
	{"Charname", VAR(charname), 2, 0, 0, 0, read_charname},
	{"Feat", VAR(feati), 1, 0, fnscript<feati>, fntest<feati>},
	{"Feature", VAR(featurei), 1, 0, fnscript<featurei>},
	{"Filter", VAR(filteri), 1, 0, fnscript<filteri>, fntest<filteri>},
	{"Global", VAR(globali), 1, 0, fnscript<globali>},
	{"Hotkey", VAR(hotkey), 2, 0, 0, 0, 0, check_hotkeys},
	{"Item", VAR(itemi), 1, 0, fnscript<itemi>},
	{"List", VAR(listi), 1, 0, fnscript<listi>, fntest<listi>},
	{"Location", VAR(locationi), 1, 0, fnscript<locationi>},
	{"Modifier", VAR(modifieri), 1, 0, fnscript<modifieri>, fntest<modifieri>},
	{"Monster", VAR(monsteri), 1, 0, fnscript<monsteri>, fntest<monsteri>, 0, check_monsters},
	{"Need", VAR(greatneedi), 1, 0, 0, 0, 0, check_need_objects},
	{"NeedFlag", VAR(needni), 1, 0, fnscript<needni>, fntest<needni>},
	{"Quest", VAR(quest), 0},
	{"Race", VAR(racei), 1, 0, fnscript<racei>},
	{"RandomTable", VAR(randomizeri), 1, 0, fnscript<randomizeri>},
	{"Script", VAR(script), 1, 0, fnscript<script>, fntest<script>},
	{"Shape", VAR(shapei), 1, 0, fnscript<shapei>, 0, shapei::read},
	{"Site", VAR(sitei), 1, 0, fnscript<sitei>},
	{"SiteSkill", VAR(siteskilli), 1, 0, 0, 0, 0, check_site_skills},
	{"Spell", VAR(spelli), 1, 0, fnscript<spelli>},
	{"Speech", VAR(speechi), 1, 0, fnscript<speechi>, 0, speech_read},
	{"Talk", VAR(talki), 1, 0, 0, 0, read_talk},
	{"Tile", VAR(tilei), 1, 0, fnscript<tilei>},
	{"TileFlag", VAR(tilefi), 1},
	{"Trigger", VAR(trigger), 3},
	{"Variant", VAR(varianti), 1},
	{"VisualEffect", VAR(visualeffect), 1},
	{"Widget", VAR(widget), 1, 0, fnscript<widget>},
};
BSDATAF(varianti)